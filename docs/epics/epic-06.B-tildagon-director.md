...
| B6b | app.py DirectorMode FSM + picker + per-show settings overlay + Show-owns-screen draw | Not started | Hardware integration; bench-verified in B9. |
